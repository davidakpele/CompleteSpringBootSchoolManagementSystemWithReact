                          ...
                          <div className="card-body">
                            <form method="post" autoComplete='off'>
                                ...
                                <div className="form-group d-invalid">
                                    ...
                                    <input ref={EdirDepartmentEffect} type="text" name="editDepartmentName" id="editDepartmentName" className="form-control" value={departmentData.deptName}  onChange={handleFacultyNameChange}/>
                ...
                <div className="modal-dialog" role="document">
                  <div className="modal-content">
                    <div className="modal-header">
                      ...
                      <button type="button" className="close" data-dismiss="modal" aria-label="Close" onClick={handleCloseNewFacultyModal} >
                    ...
                    <div className="modal-footer">
                      <button type="button" className="btn btn-secondary" onClick={handleCloseNewFacultyModal} data-dismiss="modal">Close</button>
                      <button type="button" className="btn btn-xs btn-primary pull-right" onClick={HandleAddNewDepartmentSubmitData} style={{width:'150px',marginBottom: '0',marginLeft: '5px'}}>Save new category</button>
                    </div>
                  </div>
                </div>
              </div>
