                          ...
                          <div className="card-body">
                            <form method="post" autoComplete='off'>
                                ...
                                <div className="form-group m-invalid">
                                    ...
                                    <input ref={EditFacultyFocusEffect} type="text" name="editfacultyName" id="editfacultyName" className="form-control" value={faultyData.ftyName}  onChange={handleFacultyNameChange}/>
                ...
                <div className="modal-dialog" role="document">
                  <div className="modal-content">
                    ...
                    <div className="modal-footer">
                      ...
                      <button type="button" className="btn btn-xs btn-primary pull-right" onClick={handleAddNewFaculty} style={{width:'150px',marginBottom: '0',marginLeft: '5px'}}>Save new category</button>
                    </div>
                  </div>
                </div>
              </div>
