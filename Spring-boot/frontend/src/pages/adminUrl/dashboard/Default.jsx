             ...
             <div className="content-wrapper" >
              <section className="content  text-dark">
                ...
                <div className="col-12 col-sm-6 col-md-3">
                  <Link to={"/admin/students"} style={{color:'#000'}}>
                ...
                <div className="col-12 col-sm-6 col-md-3">
                  <Link to={"/admin/professors"} style={{color:'#000'}}>
                  ...
                  <div className="col-12 col-sm-6 col-md-3">
                    <Link to={"/admin/user/list"} style={{ color: '#000' }}>
                      <div className="info-box mb-3">
                ...
                <div className="col-12 col-sm-6 col-md-3">
                  <Link to={"/admin/application"} style={{color:'#000'}}>
                    <div className="info-box mb-3">
                 ...
                 <div className="col-12 col-sm-6 col-md-3">
                  <Link to={"/admin/faculties"} style={{color:'#000'}}>
                    <div className="info-box mb-3">
                ...
                <div className="col-12 col-sm-6 col-md-3">
                  <Link to={"/admin/department"} style={{color:'#000'}}>
                    <div className="info-box mb-3">
                ...
                <div className="col-12 col-sm-6 col-md-3">
                  <Link to={"/admin/course"} style={{color:'#000'}}>
                    <div className="info-box mb-3">
                ...
                <div className="col-12 col-sm-6 col-md-3">
                 <Link to={"/admin/data_analysis"} style={{color:'#000'}}>
                    <div className="info-box mb-3">
                ...
                <div className="col-12 col-sm-6 col-md-3">
                  <Link to={"/admin/exam_review"} style={{color:'#000'}}>
                    <div className="info-box mb-3">
